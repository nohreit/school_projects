...
public interface DriverInterface {
     ...
     * <p>
     * de>ListType</code> enum has the following choices:
     * <ol>
     ...
     * <p>
     * de>TestType</code> enum has the following choices:
     * <ol>
     * 	<li>AddSortedOdd</li>
     * 	<li>AddSortedEven</li>
     * 	<li>AddAll</li>
     ...
     * </ol>
     */
    enum TestType {AddSortedOdd, AddSortedEven, AddAll, AddAllAtIndexZero, RemoveAllEven, RemoveAllOdd}
     ...
     */
    ListInterface<Integer> createList(ListType listType, TestType forTestType);
     ...
     */
    ListInterface<Integer> initializeList(ListInterface<Integer> list, int firstNumber, int lastNumber, int increment);
